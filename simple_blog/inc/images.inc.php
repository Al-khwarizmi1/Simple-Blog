...
class ImageHandler
{
	...
	{
		/*Returns the current timestamp and a number
	...
	/**
	 * Determines the filetype and extention of an image
	 * 
	...
	/**
	 * Ensures that the save direcotry exits
	 * 
	 * Checks for the existence of the supplied save dir,
	 * and creats the directory if it doesn't exist.  Creation is 
	 * recursive
	 * 
	 * @param void
	 * @return void
	...
	private function getNewDims($img)
	{
		...
		var_dump($this->max_dims);
		
		// Check that the iamge is bigger than the maximum dimensions
		if($src_w > $max_w || $src_h > $max_h)
		{
			// Determine the sacle to which the image will be resized
